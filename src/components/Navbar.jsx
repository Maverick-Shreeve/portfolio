    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-cyan-900 text-gray-300'>
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-gradient-to-r hover:bg-gradient-to-l from-purple-700 to-gray-500 flex flex-col justify-center items-center'
        }
      >
      ...
      <div className='hidden md:flex fixed flex-col top-[35%] left-0'>
        ...
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]'>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#439281]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='/'
            >
